...
namespace GameStore1.DB
{
    public class DBSeeder
    {
        public DBSeeder(GameContext dbcontext)
        {
            ...
            User user1 = new User();
            user1.Username = "Jane";
            user1.Password = "Jane123";
            dbcontext.Add(user1);

            User user2 = new User();
            user2.Username = "Wayne";
            user2.Password = "Wayne123";
            dbcontext.Add(user2);

            User user3 = new User();
            user3.Username = "Lydia";
            user3.Password = "Lydia123";
            dbcontext.Add(user3);

            User user4 = new User();
            user4.Username = "Nivi";
            user4.Password = "Nivi123";
            dbcontext.Add(user4);
